...
**SQL 알고리즘 스터디** 프로젝트에 오신 것을 환영합니다! 이 레포지토리는 참여자들이 SQL 문제를 매주 해결하고, GitHub를 통해 솔루션을 공유하며 협업하고 코드 리뷰를 통해 함께 성장하기 위한 목적을 가지고 있습니다. 우리는 **프로그래머스(Programmers)[\~Week 24]** 및 **솔브에스큐엘(solvesql)[Week 25\~]** 사이트에서 SQL 문제를 선정하여 학습할 예정입니다.
...
### Week 19: 그룹별 조건에 맞는 식당 목록 출력하기
- **문제**: [프로그래머스 문제 링크](https://school.programmers.co.kr/learn/courses/30/lessons/131124)
- **제출 기한**: 2024-02-23

### Week 20: FrontEnd 개발자 찾기
- **문제**: [프로그래머스 문제 링크](https://school.programmers.co.kr/learn/courses/30/lessons/276035)
- **제출 기한**: 2024-03-02

### Week 21: 언어별 개발자 분류하기
- **문제**: [프로그래머스 문제 링크](https://school.programmers.co.kr/learn/courses/30/lessons/276036)
- **제출 기한**: 2024-03-09

### Week 22: 상품을 구매한 회원 비율 구하기
...
### Week 24: 대장균들의 자식의 수 구하기
- **문제**: [프로그래머스 문제 링크](https://school.programmers.co.kr/learn/courses/30/lessons/299305)
- **제출 기한**: 2024-03-30

### Week 25: 복수 국적 메달 수상한 선수 찾기
- **문제**: [솔브에스큐엘 문제 링크](https://solvesql.com/problems/multiple-medalist/)
- **제출 기한**: 2024-04-06

### Week 26: 작품이 없는 작가 찾기
- **문제**: [솔브에스큐엘 문제 링크](https://solvesql.com/problems/artists-without-artworks/)
- **제출 기한**: 2024-04-13
